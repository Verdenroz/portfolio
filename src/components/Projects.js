...
import googleFinanceApi from '../assets/gfinance.png';
import financeQuery from '../assets/financequery.png';

function projectDetails(image, projectName, projectDate, projectText, skillImgs, repoImg, codeLink, documentationLink, documentationImg) {
    return (
        <div className="projects-body">
            <div className="projects-img">
                <img src={image} alt={projectName} className="projects-img"/>
            </div>
            <div className="projects-text">
                ...
                <div className="projects-skills">
                    <h3>Skills</h3>
                    <ul>
                        {skillImgs.map((skill, index) => (
                            <li key={index}><img src={skill} alt="Skill" className="skill-img"/></li>
                        ))}
                    </ul>
                </div>
                <div className="projects-links">
                    <h3>Code</h3>
                    <a target="_blank" rel="noreferrer" href={codeLink} alt="Link to project code">
                        <img src={repoImg} alt="Code for project" title="Go to repository" className="skill-img"/>
                    </a>
                </div>
                {documentationLink && documentationImg && (
                    <div className="projects-links">
                        <h3>Documentation</h3>
                        <a target="_blank" rel="noreferrer" href={documentationLink} alt="Link to project documentation">
                            {documentationImg}
                        </a>
                    </div>
                )}
        ...
        <section id="projects">
            <div className="projects-container">
                <div className="projects-header">
                    <h1>PROJECTS</h1>
                    <h2>Learning with each adventure</h2>
                </div>
                {projectDetails( 
                    financeQuery,
                    "Finance Query",
                    "May 2024",
                    "A python FastAPI server for querying financial data related to stocks and indexes. Includes additional information such as historical data, technical indicators, similar stock symbols, among other data. Hosted by AWS and the successor to Google Finance API.",
                    ["https://skillicons.dev/icons?i=python,fastapi,aws&theme=light"],
                    "https://skillicons.dev/icons?i=github&theme=light",
                    "https://github.com/Verdenroz/FinanceQuery", 
                    "https://d3tidzj12m5ipv.cloudfront.net/",
                    swaggerSVG
                )}
                {projectDetails(
                    googleFinanceApi, 
                    "Google Finance API", 
                    "March 2024", 
                    "A javascript web scraper for stocks and market indexes using data from Google Finance. Deployed by firebase.", 
                    ["https://skillicons.dev/icons?i=javascript,firebase&theme=light"], 
                    "https://skillicons.dev/icons?i=github&theme=light",
                    "https://github.com/Verdenroz/GoogleFinanceAPI", 
                    "https://app-coujq7nbwq-uc.a.run.app/api-docs/",
                    swaggerSVG
                )}
                {projectDetails(
                    wheresWhat, 
                    "Where's What", 
                    "December 2023", 
                    "An app that shows a campus map of SUNY Farmingdale with pinpoints showing nearby events and amenities.", 
                    ["https://skillicons.dev/icons?i=java,kotlin&theme=light", "https://skillicons.dev/icons?i=androidstudio,firebase&theme=light", "https://skillicons.dev/icons?i=materialui,figma&theme=light"], 
                    "https://skillicons.dev/icons?i=gitlab&theme=light",
                    "https://gitlab.com/fsc-clam/fsc-wheres-what", 
                )}
            </div>
        </section>
    );
