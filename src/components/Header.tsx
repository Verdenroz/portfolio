...
const Header = () => {
  return (
    <div className="flex flex-col justify-evenly gap-6 lg:items-end lg:h-screen lg:w-1/3 lg:px-8 lg:py-2 p-6 h-fit w-screen bg-[#181b22] lg:fixed sticky top-0 z-50">
      {/* Profile */}
      <div className="flex flex-col gap-8 items-center justify-center">
        <img
          className="md:size-64 size-48 rounded-full border-4 border-white shrink-0"
          src={avatar}
          alt="Avatar"
        />
        <div className="items-center justify-center">
          <h1 className="text-3xl text-center font-black font-display text-white hover:text-blue-500">
            Harvey Tseng
          </h1>
          ...
          <ul className="flex mt-8 list-none items-center justify-evenly ml-6">
            <li>
              <a
                target="_blank"
              ...
              >
                <svg
                  ...
                  height="48"
                  viewBox="0 0 64 64"
                  className="fill-white hover:fill-blue-500 hover:shadow-lg hover:shadow-blue-500/50 cursor-pointer"
                >
            ...
            <li>
              <a
                target="_blank"
                href="https://drive.google.com/file/d/1sHBjy8zEze9djtMVeqhUAFld9JTwJb-s/view?usp=sharing"
                download
                rel="noreferrer"
                aria-label="Resume"
                className="bg-[#181b22] border-2 border-white text-white p-2 rounded-3xl hover:text-blue-500 hover:border-blue-500 hover:shadow-lg hover:shadow-blue-500/50 cursor-pointer"
              >
      ...
      <div className="w-full flex lg:flex-col flex-wrap justify-center items-center lg:gap-2 gap-4">
        <h2 className="text-xl font-bold font-display text-white">Skills</h2>
